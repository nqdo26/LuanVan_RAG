...
def create_chat_completion(payload: ChatCompletionPayload):
    ...
    user_prompt = (
        ...
        "- Nếu user hỏi về 'chụp hình, check-in': Chọn địa điểm có tag 'chụp ảnh sống ảo'\n"
        ...
        "- Nếu user hỏi về 'ẩm thực địa phương, ẩm thực đặc trưng, mòn ăn địa phương': Chọn các nhà hàng hoặc quán ăn có tag 'Ẩm thực địa phương'\n"
        "\n"
